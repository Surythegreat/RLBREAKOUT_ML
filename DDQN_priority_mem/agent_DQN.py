...
class Agent:
    ...
    def train(self, num_epochs):
        ...
        """
        log_file = 'DDQN/training_log.csv'
        ...
        for epoch in range(num_epochs):
            ...
            while not done:
                ...
                if self.memory.can_sample(self.BATCH_SIZE):
                    state_b, action_b, next_state_b, reward_b, done_b,tree_index,is_weigths = self.memory.sample(self.BATCH_SIZE)
                    ...
                    loss = (is_weigths * (qsa_b - target_b).pow(2)).mean()
            ...
            with open(log_file, 'a', newline='') as f:
                writer = csv.writer(f)
                writer.writerow([epoch+2745, total_epoch_reward, self.epsilon, last_loss.item()])
    ...
    def test(self, num_episodes):
        ...
        video_dir = "DDQN_priority_mem/Video"
