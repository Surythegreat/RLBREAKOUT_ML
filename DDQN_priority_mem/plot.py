...
def plot_training_data(log_file='DDQN/training_log.csv', output_dir='DDQN/plots'):
    """
    ...
    loss_data['Smoothed Loss'] = loss_data['Loss'].rolling(window=100, min_periods=1).mean() *100
