...
class Agent:
    ...
    def train(self, num_epochs):
        ...
        for epoch in range(num_epochs):
            ...
            state_tensor = torch.FloatTensor(np.array(frame)).unsqueeze(0).unsqueeze(0).to(self.device)
            ...
            while not done:
                ...
                next_state_tensor = torch.FloatTensor(np.array(next_frame)).unsqueeze(0).unsqueeze(0).to(self.device)
    ...
    def test(self, num_episodes):
        ...
        video_dir = "DQN_noFRAMESTk/Video"
