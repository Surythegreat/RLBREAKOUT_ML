    ...
    def train(self, num_epochs):
        ...
        for epoch in range(num_epochs):
            ...
            while not done:
                ...
                self.memory.insert([state_tensor, action_tensor, next_state_tensor, reward_tensor, done_tensor])
            ...
            with open(log_file, 'a', newline='') as f:
                writer = csv.writer(f)
                writer.writerow([epoch+10571, total_epoch_reward, self.epsilon, last_loss.item()])
